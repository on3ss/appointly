        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setData('settings', {
                                    ...data.settings,
                                    average_service_duration: e.target.value,
                                })
                            }
                            required
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setData('settings', {
                                    ...data.settings,
                                    max_queue_capacity: e.target.value,
                                })
                            }
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                        />
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) =>
                        setData('location_address', e.target.value)
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                />
            </div>
            ...
            <div className="flex space-x-6">
                <label className="inline-flex items-center">
                    <input
                        ...
                        onChange={(e) =>
                            setData('is_recurring_allowed', e.target.checked)
                        }
                        className="rounded border-gray-300"
                    />
                ...
                <label className="inline-flex items-center">
                    <input
                        ...
                        onChange={(e) =>
                            setData('requires_membership', e.target.checked)
                        }
                        className="rounded border-gray-300"
                    />
