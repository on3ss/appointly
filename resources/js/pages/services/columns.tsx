...
export const columns: ColumnDef<Service>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            switch (type) {
                case 'queue': variant = "secondary"; break;
                case 'timeslot': variant = "default"; break;
            }
        ...
        return (
            <div className="text-right">
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => alert(`Edit service: ${service.name} (dummy action)`)}>
                        <Pencil className="mr-2 h-4 w-4" /> Edit
                    </DropdownMenuItem>
                    <DropdownMenuItem
                        onClick={() => alert(`Delete service: ${service.name} (dummy action)`)}
